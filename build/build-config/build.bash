#!/bin/bash
#
# svn $Id: build.bash 709 2014-01-23 20:09:38Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
export        MY_ROOT_DIR=${BUILD_DIR}/roms/roms_src
...
#export       MY_ROMS_SRC=${MY_ROOT_DIR}/branches/arango
 export       MY_ROMS_SRC=${BUILD_DIR}/roms/roms_src
...
# these configurations files up-to-date.
 ...
 export         COMPILERS=${BUILD_DIR}/roms/roms_src/Compilers
    ...
    ifort )
      ...
      if [ -n "${USE_MPI:+1}" ]; then
        if [ "${which_MPI}" = "mpich" ]; then
          ...
          export      MCT_INCDIR=${INSTALL_DIR}/include
          export      MCT_LIBDIR=${INSTALL_DIR}/lib
      ...
      if [ -n "${USE_NETCDF4:+1}" ]; then
        ...
        export     NETCDF_INCDIR=${INSTALL_DIR}/include
        export     NETCDF_LIBDIR=${INSTALL_DIR}/lib
      fi
      ;;
...
# etc).
 ...
 export     MY_HEADER_DIR=${BUILD_DIR}/roms/include

 export MY_ANALYTICAL_DIR=${BUILD_DIR}/roms/include
